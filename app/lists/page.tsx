...
export default async function ListsPage() {
  ...
  const { data: rawLists } = await supabase.from("lists").select("id,name,description,visibility,updated_at,cover_url,featured_media_id").eq("user_id", user.id).order("name", { ascending: true });
